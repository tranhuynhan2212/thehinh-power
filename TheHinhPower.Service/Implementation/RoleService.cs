...
namespace TheHinhPower.Service.Implementation
{
    public class RoleService : IRoleService
    {
        ...
        public RoleService(RoleManager<AppRole> roleManager, IRepository<Function, Guid> functionRepository, IRepository<Permission, Guid> permissionRepository,
        ...
        public Task<bool> CheckPermission(string functionId, string action, string[] roles)
        {
            ...
            if (functions.Any() && permissions.Any())
            {
        ...
        {
            var query = _roleManager.Roles.Where(r => r.Name != "Admin");
