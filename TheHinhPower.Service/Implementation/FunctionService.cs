...
namespace TheHinhPower.Service.Implementation
{
    public class FunctionService : IFunctionService
    {
        ...
        public FunctionService(RoleManager<AppRole> roleManager, IFunctionRepository functionRepository, IUnitOfWork unitOfWork, IMapper mapper)
        {
        ...
        public Task<List<FunctionViewModel>> GetListFunctionWithRoleName(string[] roles)
        {
            var functions = _functionRepository.FindAll();
            return functions.OrderBy(x => x.SortOrder).ProjectTo<FunctionViewModel>().ToListAsync();
        }
